...
//        }
    ...
    public void postSetAdapter(MessageListAdapter adapter) {
        mAdapter.setOnItemClickListener(new MessageLayout.OnItemClickListener() {
            ...
            @Override
            public void onConcelClick(View view, int position, MessageInfo messageInfo) {
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onConcelClick(view, position, messageInfo);
                }
            }

            @Override
            public void onEnterClick(View view, int position, MessageInfo messageInfo) {
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onEnterClick(view, position, messageInfo);
                }
            }
    ...
    public interface OnItemClickListener {
        ...
        void onConcelClick(View view, int position, MessageInfo messageInfo);
        void onEnterClick(View view, int position, MessageInfo messageInfo);
